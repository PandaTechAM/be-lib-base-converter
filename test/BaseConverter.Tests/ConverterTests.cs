...
public class ConverterTests
{
    ...
    {
        var result1 = PandaBaseConverter.Base36ToBase10NotNull("i6");
        var result2 = PandaBaseConverter.Base36ToBase10NotNull("4p8u2");
        var result3 = PandaBaseConverter.Base36ToBase10NotNull("21i3v9");
        var result4 = PandaBaseConverter.Base36ToBase10NotNull("3i0b8x6yn");
        Assert.Equal(654, result1);
        Assert.Equal(7896314, result2);
        Assert.Equal(123456789, result3);
        Assert.Equal(9874564789631, result4);
